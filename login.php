...
<head>
        ...
        <title>Login - Universitas Pendidikan Indonesia</title>
        <link href="<?= $main_url ?>asset/sb-admin/startbootstrap-sb-admin-gh-pages/css/styles.css" rel="stylesheet" />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4">Login - Universitas Pendidikan Indonesia</h4></div>
                                    <div class="card-body">
                                        <form>
